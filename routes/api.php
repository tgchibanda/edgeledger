...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('superuser')->group(function () {
        ...
        Route::get('admin/subscription/pending-count',    [AdminSubscriptionController::class, 'pendingCount']);
        ...
        Route::get('admin/payment-proof/{payment}',       [AdminSubscriptionController::class, 'serveProof']);
    });
});